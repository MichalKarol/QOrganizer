        ...
        for(uint j=0;j<Mailv[i].Mboxv.size();j++)
        {
            ...
            for(uint k=0;k<Mailv[i].Mboxv[j]->Mbox_Children.size();k++)
            {
                for(uint l=0;l<Mailv[i].Mboxv.size();l++)
                {
                    ...
                    {
                        Childrens.append(OutputTools((int)l,"MBOX_CHILDINT"));
                        break;
                    }
                }
            }
            ...
            for(uint k=0;k<Mailv[i].Mboxv[j]->Emailv.size();k++)
            {
                ...
                work2.append(OutputTools((int)Mailv[i].Mboxv[j]->Emailv[k]->Email_UID,"EMAIL_UID"));
                ...
                for(uint l=0;l<Mailv[i].Mboxv[j]->Emailv[k]->Structurev.size();l++)
                {
                    ...
                    work3.append(OutputTools((int)Mailv[i].Mboxv[j]->Emailv[k]->Structurev[l]->Structure_Size,"STRUCTURE_SIZE"));
                    work3.append(OutputTools((int)Mailv[i].Mboxv[j]->Emailv[k]->Structurev[l]->Structure_Lines,"STRUCTURE_LINES"));
