...
bool qorgIO::ReadFile(QString *hashed,QString *hash,QOrganizer *main,QString path)
{
    ...
    delete[] Output;
    delete aesKey;
    if(Decrypted.indexOf("<ORG>")==-1||Decrypted.indexOf("</ORG>")==-1||Decrypted.indexOf("QOrganizer")==-1)
    {
...
void qorgIO::SaveFile(QString *hashed,QString *hash,QOrganizer *main,QString path)
{
    ...
    data.append(OutputTools((int)main->UInterval,"UINTERVAL"));
    data.append(OutputTools((int)main->BInterval,"BINTERVAL"));
